                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()) {
                                    ...
                                    Toast.makeText(customerForgotPassword.this, "password reset link sent to your email!", Toast.LENGTH_SHORT).show();

                                }
                                else {
                                    Toast.makeText(customerForgotPassword.this,task.getException().getMessage(), Toast.LENGTH_SHORT).show();
